...
const FileExplorer: React.FC = () => {
  ...
  return (
    <div className="glass-card rounded-xl flex flex-col h-full max-h-[calc(100vh-75px)]">
      <div className=" py-1">
        {selectedFile && (
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200/50 dark:border-gray-700/50 bg-gray-50/70 dark:bg-gray-800/60">
